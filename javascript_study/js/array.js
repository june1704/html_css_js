...
console.log(numbers.concat([11, 12, 13, 14, 15]));  // concat: 두 배열의 병합
console.log(numbers);
...
const newNumbers5 = numbers.splice(3, 1); // 3번 인덱스에 1개 꺼내와라
console.log(newNumbers5);
console.log(numbers)

const newNumbers6 = numbers.splice(4, 2, 11, 12); // 4번 인덱스에 2개를 꺼내고 그 자리에 (11, 12, 13)를 집어넣어라
console.log(newNumbers6);
console.log(numbers);
numbers.splice(4, 0, 20, 21) // 0은 안 꺼내옴
console.log(numbers)
